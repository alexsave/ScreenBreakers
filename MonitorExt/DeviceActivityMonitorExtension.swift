...
class DeviceActivityMonitorExtension: DeviceActivityMonitor {
    ...
    func scheduleNotification(with title: String) {
        ...
        center.requestAuthorization(options: [.alert, .sound, .badge]) { granted, error in
            if granted {
                ...
                let request = UNNotificationRequest(identifier: "MyNotification"+title, content: content, trigger: trigger)
    ...
    override func intervalDidStart(for activity: DeviceActivityName) {
        ...
        scheduleNotification(with: "interval did start"+activity.rawValue)
    }
    ...
    override func intervalDidEnd(for activity: DeviceActivityName) {
        ...
        scheduleNotification(with: "interval did end"+activity.rawValue)
    }
